    ...
    <div className='Navbar'>
        ...
        <div className="wrapper">
            ...
            <motion.div variants={logoVariants}  initial="initial" animate="animate" className="social">
                ...
                <motion.a href="https://drive.google.com/file/d/1LmQtPSxoR2kVCgHsKFq6RS3JUu0CxBzP/view?usp=sharing" target='_blank'><motion.img variants={logoVariants} src='/assets/resume.png' /></motion.a>
            </motion.div>
        </div>
    </div>
  )
